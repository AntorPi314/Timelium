...
const AddEducationDialog: React.FC<AddEducationDialogProps> = ({ open, onClose, onEducationAdded }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!token) {
        toast.error("Please login to add education.");
        return;
      }

      await axios.post(`${API_URL}/users/education`, formData, {
        headers: {
      ...
      setFormData({ institution: "", degree: "", field: "", year: "" });
